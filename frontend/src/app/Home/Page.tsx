    ...
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-100 font-sans scroll-smooth">
      ...
      <section id="predict" className="min-h-screen flex items-center py-20 border-b border-zinc-800/50 bg-zinc-950/50">
        <div className="max-w-7xl mx-auto px-6 w-full flex flex-col items-center">
          ...
          {predictionResult && (
            <div className="w-full mt-12 p-8 bg-zinc-900/50 border border-zinc-800 rounded-xl">
              <h3 className="text-2xl font-semibold mb-6">Prediction Report</h3>
              <div className="bg-zinc-950 p-6 rounded-lg font-mono text-sm text-zinc-300 whitespace-pre-wrap">
                {typeof predictionResult === 'object' ? JSON.stringify(predictionResult, null, 2) : predictionResult}
              </div>
            </div>
          )}
